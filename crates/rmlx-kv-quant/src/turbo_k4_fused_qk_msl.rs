...
//! # Qwen MoE guard
//!
//! `TurboSym4` stores K at 4 bits, so Qwen MoE rejects it. The guard lives in [`rmlx_models::kv_cache::cache_type::validate_resolved`]
...
const TURBO_K4_FUSED_QK_HEADER: &str = include_str!("metal/turbo_k4_fused_qk_header.metal");

const TURBO_K4_FUSED_QK_SOURCE: &str = include_str!("metal/turbo_k4_fused_qk.metal");
