...
//!
//! Per CLAUDE.md, callers must hold the Metal claim before dispatching.
...
const QUANTIZE_SOURCE_ISO3: &str = include_str!("metal/isoquant_quantize_iso3.metal");
...
const DEQUANTIZE_SOURCE_ISO3: &str = include_str!("metal/isoquant_dequantize_iso3.metal");
