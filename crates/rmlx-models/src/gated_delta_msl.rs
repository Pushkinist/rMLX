...
// in mlx-lm 0.31's `mlx_lm/models/gated_delta.py`.
//
...
// at dispatch time.
//
// We use NO mask and NON-vectorized gating. Qwen3.6's `gated_delta_update`
// always takes that branch (g is `[B, T, Hv]`, mask is None).
