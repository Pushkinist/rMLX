...
//! - `impl HydratedEntry for LagunaEntry`: what an SSD-restored block becomes
...
/// What an SSD-restored block becomes as a `LagunaEntry`.
///
...
impl HydratedEntry for LagunaEntry {
    const SHARES_KV: bool = crate::laguna::SHARES_KV_ACROSS_LAYERS;
