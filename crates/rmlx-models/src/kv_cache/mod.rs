...
/// validator accepts.
///
/// Only the two parametric families are named. Every other codec, a new one
/// too, takes the `K8V8` fallback. What catches a new store-bearing codec that
/// lands there by mistake is
