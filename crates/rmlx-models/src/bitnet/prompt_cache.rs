...
//! - `impl HydratedEntry for BitNetEntry`: what an SSD-restored block becomes
...
/// What an SSD-restored block becomes as a `BitNetEntry`.
///
...
impl HydratedEntry for BitNetEntry {
    const SHARES_KV: bool = crate::bitnet::SHARES_KV_ACROSS_LAYERS;
...
/// and Qwen3 dense.
pub(crate) static PROMPT_CACHE: ArchPromptCache<BitNetEntry> = ArchPromptCache::new(
    "BitNetForCausalLM",
