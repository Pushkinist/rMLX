...
| [`docs/SPEC_ROUND_SKELETON.md`](docs/SPEC_ROUND_SKELETON.md) | **Migrating (chunk 1 of 7 landed)**: one round loop and a drafter interface for the seven speculative loops — what it cannot express, the migration order, the oracle and the mutation list |
