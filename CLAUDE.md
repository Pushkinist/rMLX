...
| `make check-kv-codec-disposition-fixtures` | CI gate (in `make ci`): recall test for the above, 22 synthetic scan roots (one edit each), each asserting which rule fired and exit 2 vs exit 1. |
