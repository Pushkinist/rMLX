...
| `make check-spec-charge-fixtures` | CI gate (in `make ci`): recall test for the above, 11 synthetic scan roots carrying the tree's own census, each asserting the reason as well as exit 1 vs exit 2. |
