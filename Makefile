...
check-spec-sampling-fixtures: ## CI gate: recall test for the above — 25 cases over two tree shapes, each asserting the reason as well as exit 1 vs exit 2
...
check-spec-charge-fixtures: ## CI gate: recall test for the above — 74 cases over three tree shapes, each asserting the reason as well as exit 1 vs exit 2
