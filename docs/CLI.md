...
| `MLX_VLM_DRAFT_BLOCK_SIZE` | `--draft-block-size` | 5, capped by the declared depth | Speculative round block, verifier token included; ≥ 2. Flag wins. |
