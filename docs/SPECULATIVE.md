...
`docs/KV_STORE_TRUNCATION.md` § "The `Mixed` arm truncates to its fill marker". `KvStorage::reset` had the identical defect and is
...
out-of-range index. See `docs/KV_STORE_TRUNCATION.md` § "Every store cuts its own
payload".
